package com.qquique.jamm.application.util;

import java.util.ResourceBundle;

public class ErrorMessages {
    private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("com.qquique.jamm.application.errormessages");
